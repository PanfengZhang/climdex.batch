...
for(i in 1:StationNumbers) {
  ...
  ci <- climdexInput.raw(tmax = dd$tmax, tmin = dd$tmin, prec = dd$prcp,
                         ...
                         max.missing.days = c(annual = 15, monthly = 7),
  ...
  txx <- climdex.txx(ci, freq = "monthly")
  ...
  tnx <- climdex.tnx(ci, freq = "monthly")
  ...
  txn <- climdex.txn(ci, freq = "monthly")
  ...
  tnn <- climdex.tnn(ci, freq = "monthly")
  ...
  tn10p <- climdex.tn10p(ci, freq = "monthly")
  ...
  tn10p <- tn10p[, c("year", "month", "tn10p")]
  ...
  tx10p <- climdex.tx10p(ci, freq = "monthly")
  ...
  tx10p <- tx10p[, c("year", "month", "tx10p")]
  ...
  tn90p <- climdex.tn90p(ci, freq = "monthly")
  ...
  tn90p <- tn90p[, c("year", "month", "tn90p")]
  ...
  tx90p <- climdex.tx90p(ci, freq = "monthly")
  ...
  tx90p <- tx90p[, c("year", "month", "tx90p")]
  ...
  dtr[, "year"]  <- as.integer(substr(rownames(dtr), start = 1, stop = 4))
  dtr[, "month"] <- as.integer(substr(rownames(dtr), start = 6, stop = 7))
  ...
  rx1day <- climdex.rx1day(ci, freq = "monthly")
  ...
  rx5day <- climdex.rx5day(ci, freq = "monthly")
